function [ u, e, iter ] = HelmholtzSolverSOR( Lambda, N, h, etarget, F, nbc, nflag, ebc, eflag, sbc, sflag, wbc, wflag, w )
...
%   This solver uses the Gauss-Seidel Iteritive Method with Successive Over Relaxation to find a solution
        ...
        for j = 2:N-1
            ...
            for i = 2:2:N-1                
                ...
                if i == N-1
                    ...
                    u(i+1,j) = w*u(i+1,j) + (1-w)*uprev(i+1,j);
                end
